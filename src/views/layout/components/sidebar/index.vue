...
export default {
  ...
  computed: {
    active: {
      ...
      set () {
        this.$store.dispatch('toggleSidebarActiveState')
      }
    },
    notExpand: {
      get () {
        return this.$store.getters.sidebarNotExpand
      },
      set (value) {
        this.$store.dispatch('toggleSidebarExpandState')
      }
    },
    reduce: {
      get () {
        return this.$store.getters.sidebarReduce
      },
      set (value) {
        this.$store.dispatch('toggleSidebarReduceState')
      }
    }
  }
}
